...
public class Potato implements Comparable<Potato> {
    ...
    public int compareTo(Potato o) {
        double alfaOne = this.weight * 0.5 + 0.65 * this.length + 0.8 * this.girth;
        double alfaTwo = o.weight * 0.5 + 0.65 * o.length + 0.8 * o.girth;
        return Double.compare(alfaOne,alfaTwo);
